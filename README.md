...
├── app.py, app_v2.py, app_preview.py ← 6강 기본 앱 / 7강 고급 앱 / 5강 예고용 미리보기
...
7강 화면은 6강과 같은 깔끔한 단일 페이지 톤을 유지하면서, 신뢰도 bar chart, 멀티파일 비교, 예측 이력까지 추가합니다.
...
- `app_v2.py`는 6강 디자인을 기준으로 다시 정리했지만, 내부 기능은 7강용 확장판입니다.
